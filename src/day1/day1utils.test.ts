...
describe("Advent of Code 2024 Day 1", () => {
  ...
  test("summed distance between two numbers using 2 ordered arrays of equal length", () => {
    expect(
      summedDistanceBetweenTwoNumbersAfterOrderingArray([1, 2], [1, 2])
    ).toEqual(0);
    expect(
      summedDistanceBetweenTwoNumbersAfterOrderingArray([1, 2], [2, 3])
    ).toEqual(2);
  });
  ...
  test("summed distance between two numbers with 2 unordered arrays of equal length", () => {
    ...
    expect(
      summedDistanceBetweenTwoNumbersAfterOrderingArray(array1, array2)
    ).toEqual(11);
  });
